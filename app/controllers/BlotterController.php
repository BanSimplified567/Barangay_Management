...
class BlotterController {
    ...
    private function addForm() {
        ...
        require_once '../app/views/blotters/add_blotter.php';
    }
    ...
    private function editForm($id) {
        ...
        require_once '../app/views/blotters/edit_blotter.php';
    }

    private function create() {
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            header("Location: index.php?action=blotters&sub=add");
            exit();
        }
    ...
    private function update($id) {
        ...
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            header("Location: index.php?action=blotters&sub=edit&id=$id");
            exit();
        }
    ...
    private function settle($id) {
        ...
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            ...
            require_once '../app/views/blotters/settle_blotter.php';
            return;
        }
