...
<div class="container-fluid">
  <h1 class="h3 mb-4 text-gray-800"><?php echo $title ?? 'Mark Blotter as Settled'; ?></h1>
        ...
        <div class="card-body">
          <form action="index.php?action=blotters&sub=settle&id=<?php echo $blotter['id']; ?>" method="POST">
            ...
            <div class="mb-3">
              ...
              <p class="form-control-plaintext"><?php echo nl2br(htmlspecialchars($blotter['description'])); ?></p>
            </div>
